...
#define MASK_BIT_RANGE(type, f, l) (((((type)1) << ((l) - (f) + 1)) - 1) << (f))
...
int strip_cmdline_int(int* pargc,
                      char*** pargv,
                      const char* key,
                      int default_val);
...
double strip_cmdline_double(int* pargc,
                            char*** pargv,
                            const char* key,
                            double default_val);
...
const char* strip_cmdline_string(int* pargc,
                                 char*** pargv,
                                 const char* key,
