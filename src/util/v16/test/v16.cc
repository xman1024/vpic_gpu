...
TEST(v16, test_transpose) {
    ...
    v16int a06(96, 97, 98, 99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109,
               110, 111);
    v16int a07(112, 113, 114, 115, 116, 117, 118, 119, 120, 121, 122, 123, 124,
               125, 126, 127);
    v16int a08(128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 140,
               141, 142, 143);
    v16int a09(144, 145, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156,
               157, 158, 159);
    v16int a10(160, 161, 162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172,
               173, 174, 175);
    v16int a11(176, 177, 178, 179, 180, 181, 182, 183, 184, 185, 186, 187, 188,
               189, 190, 191);
    v16int a12(192, 193, 194, 195, 196, 197, 198, 199, 200, 201, 202, 203, 204,
               205, 206, 207);
    v16int a13(208, 209, 210, 211, 212, 213, 214, 215, 216, 217, 218, 219, 220,
               221, 222, 223);
    v16int a14(224, 225, 226, 227, 228, 229, 230, 231, 232, 233, 234, 235, 236,
               237, 238, 239);
    v16int a15(240, 241, 242, 243, 244, 245, 246, 247, 248, 249, 250, 251, 252,
               253, 254, 255);

    transpose(a00, a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, a11, a12,
              a13, a14, a15);

    ASSERT_FALSE(any(a00 != v16int(0, 16, 32, 48, 64, 80, 96, 112, 128, 144,
                                   160, 176, 192, 208, 224, 240)) ||
                 any(a01 != v16int(1, 17, 33, 49, 65, 81, 97, 113, 129, 145,
                                   161, 177, 193, 209, 225, 241)) ||
                 any(a02 != v16int(2, 18, 34, 50, 66, 82, 98, 114, 130, 146,
                                   162, 178, 194, 210, 226, 242)) ||
                 any(a03 != v16int(3, 19, 35, 51, 67, 83, 99, 115, 131, 147,
                                   163, 179, 195, 211, 227, 243)) ||
                 any(a04 != v16int(4, 20, 36, 52, 68, 84, 100, 116, 132, 148,
                                   164, 180, 196, 212, 228, 244)) ||
                 any(a05 != v16int(5, 21, 37, 53, 69, 85, 101, 117, 133, 149,
                                   165, 181, 197, 213, 229, 245)) ||
                 any(a06 != v16int(6, 22, 38, 54, 70, 86, 102, 118, 134, 150,
                                   166, 182, 198, 214, 230, 246)) ||
                 any(a07 != v16int(7, 23, 39, 55, 71, 87, 103, 119, 135, 151,
                                   167, 183, 199, 215, 231, 247)) ||
                 any(a08 != v16int(8, 24, 40, 56, 72, 88, 104, 120, 136, 152,
                                   168, 184, 200, 216, 232, 248)) ||
                 any(a09 != v16int(9, 25, 41, 57, 73, 89, 105, 121, 137, 153,
                                   169, 185, 201, 217, 233, 249)) ||
                 any(a10 != v16int(10, 26, 42, 58, 74, 90, 106, 122, 138, 154,
                                   170, 186, 202, 218, 234, 250)) ||
                 any(a11 != v16int(11, 27, 43, 59, 75, 91, 107, 123, 139, 155,
                                   171, 187, 203, 219, 235, 251)) ||
                 any(a12 != v16int(12, 28, 44, 60, 76, 92, 108, 124, 140, 156,
                                   172, 188, 204, 220, 236, 252)) ||
                 any(a13 != v16int(13, 29, 45, 61, 77, 93, 109, 125, 141, 157,
                                   173, 189, 205, 221, 237, 253)) ||
                 any(a14 != v16int(14, 30, 46, 62, 78, 94, 110, 126, 142, 158,
                                   174, 190, 206, 222, 238, 254)) ||
                 any(a15 != v16int(15, 31, 47, 63, 79, 95, 111, 127, 143, 159,
...
TEST(v16, test_load_16x16_tr) {
    ...
    v16int a00, a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, a11, a12, a13,
        a14, a15;
    ...
    load_16x16_tr(mem, mem + 16, mem + 32, mem + 48, mem + 64, mem + 80,
                  mem + 96, mem + 112, mem + 128, mem + 144, mem + 160,
                  mem + 176, mem + 192, mem + 208, mem + 224, mem + 240, a00,
...
TEST(v16, test_load_16x8_tr_p) {
    ...
    load_16x8_tr_p(mem, mem + 16, mem + 32, mem + 48, mem + 64, mem + 80,
                   mem + 96, mem + 112, a00, a01, a02, a03, a04, a05, a06, a07);

    for (i = 0; i < 128; i++)
        if (mem[i] != i)
            break;

    ASSERT_FALSE(any(a00 != v16int(0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88,
                                   96, 104, 112, 120)) ||
                 any(a01 != v16int(1, 9, 17, 25, 33, 41, 49, 57, 65, 73, 81, 89,
                                   97, 105, 113, 121)) ||
                 any(a02 != v16int(2, 10, 18, 26, 34, 42, 50, 58, 66, 74, 82,
                                   90, 98, 106, 114, 122)) ||
                 any(a03 != v16int(3, 11, 19, 27, 35, 43, 51, 59, 67, 75, 83,
                                   91, 99, 107, 115, 123)) ||
                 any(a04 != v16int(4, 12, 20, 28, 36, 44, 52, 60, 68, 76, 84,
                                   92, 100, 108, 116, 124)) ||
                 any(a05 != v16int(5, 13, 21, 29, 37, 45, 53, 61, 69, 77, 85,
                                   93, 101, 109, 117, 125)) ||
                 any(a06 != v16int(6, 14, 22, 30, 38, 46, 54, 62, 70, 78, 86,
                                   94, 102, 110, 118, 126)) ||
                 any(a07 != v16int(7, 15, 23, 31, 39, 47, 55, 63, 71, 79, 87,
                                   95, 103, 111, 119, 127)) ||
                 i != 128);
}
...
TEST(v16, test_load_16x16_tr_p) {
    ...
    load_16x16_tr_p(mem, mem + 16, mem + 32, mem + 48, mem + 64, mem + 80,
                    mem + 96, mem + 112, mem + 128, mem + 144, mem + 160,
                    mem + 176, mem + 192, mem + 208, mem + 224, mem + 240, a00,
                    a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, a11, a12,
                    a13, a14, a15);
    ...
    ASSERT_FALSE(any(a00 != v16int(0, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88,
                 ...
                 any(a07 != v16int(7, 15, 23, 31, 39, 47, 55, 63, 71, 79, 87,
                                   95, 103, 111, 119, 127)) ||
                 any(a08 != v16int(128, 136, 144, 152, 160, 168, 176, 184, 192,
                                   200, 208, 216, 224, 232, 240, 248)) ||
                 any(a09 != v16int(129, 137, 145, 153, 161, 169, 177, 185, 193,
                                   201, 209, 217, 225, 233, 241, 249)) ||
                 any(a10 != v16int(130, 138, 146, 154, 162, 170, 178, 186, 194,
                                   202, 210, 218, 226, 234, 242, 250)) ||
                 any(a11 != v16int(131, 139, 147, 155, 163, 171, 179, 187, 195,
                                   203, 211, 219, 227, 235, 243, 251)) ||
                 any(a12 != v16int(132, 140, 148, 156, 164, 172, 180, 188, 196,
                                   204, 212, 220, 228, 236, 244, 252)) ||
                 any(a13 != v16int(133, 141, 149, 157, 165, 173, 181, 189, 197,
                                   205, 213, 221, 229, 237, 245, 253)) ||
                 any(a14 != v16int(134, 142, 150, 158, 166, 174, 182, 190, 198,
                                   206, 214, 222, 230, 238, 246, 254)) ||
                 any(a15 != v16int(135, 143, 151, 159, 167, 175, 183, 191, 199,
...
TEST(v16, test_store_16x16_tr) {
    ...
    v16int a00(0, 16, 32, 48, 64, 80, 96, 112, 128, 144, 160, 176, 192, 208,
               224, 240);
    v16int a01(1, 17, 33, 49, 65, 81, 97, 113, 129, 145, 161, 177, 193, 209,
               225, 241);
    v16int a02(2, 18, 34, 50, 66, 82, 98, 114, 130, 146, 162, 178, 194, 210,
               226, 242);
    v16int a03(3, 19, 35, 51, 67, 83, 99, 115, 131, 147, 163, 179, 195, 211,
               227, 243);
    v16int a04(4, 20, 36, 52, 68, 84, 100, 116, 132, 148, 164, 180, 196, 212,
               228, 244);
    v16int a05(5, 21, 37, 53, 69, 85, 101, 117, 133, 149, 165, 181, 197, 213,
               229, 245);
    v16int a06(6, 22, 38, 54, 70, 86, 102, 118, 134, 150, 166, 182, 198, 214,
               230, 246);
    v16int a07(7, 23, 39, 55, 71, 87, 103, 119, 135, 151, 167, 183, 199, 215,
               231, 247);
    v16int a08(8, 24, 40, 56, 72, 88, 104, 120, 136, 152, 168, 184, 200, 216,
               232, 248);
    v16int a09(9, 25, 41, 57, 73, 89, 105, 121, 137, 153, 169, 185, 201, 217,
               233, 249);
    v16int a10(10, 26, 42, 58, 74, 90, 106, 122, 138, 154, 170, 186, 202, 218,
               234, 250);
    v16int a11(11, 27, 43, 59, 75, 91, 107, 123, 139, 155, 171, 187, 203, 219,
               235, 251);
    v16int a12(12, 28, 44, 60, 76, 92, 108, 124, 140, 156, 172, 188, 204, 220,
               236, 252);
    v16int a13(13, 29, 45, 61, 77, 93, 109, 125, 141, 157, 173, 189, 205, 221,
               237, 253);
    v16int a14(14, 30, 46, 62, 78, 94, 110, 126, 142, 158, 174, 190, 206, 222,
               238, 254);
    v16int a15(15, 31, 47, 63, 79, 95, 111, 127, 143, 159, 175, 191, 207, 223,
               239, 255);
    ...
    store_16x16_tr(a00, a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, a11,
                   a12, a13, a14, a15, mem, mem + 16, mem + 32, mem + 48,
                   mem + 64, mem + 80, mem + 96, mem + 112, mem + 128,
                   mem + 144, mem + 160, mem + 176, mem + 192, mem + 208,
                   mem + 224, mem + 240);
...
TEST(v16, test_store_16x8_tr_p) {
    ...
    v16int a02(2, 10, 18, 26, 34, 42, 50, 58, 66, 74, 82, 90, 98, 106, 114,
               122);
    v16int a03(3, 11, 19, 27, 35, 43, 51, 59, 67, 75, 83, 91, 99, 107, 115,
               123);
    v16int a04(4, 12, 20, 28, 36, 44, 52, 60, 68, 76, 84, 92, 100, 108, 116,
               124);
    v16int a05(5, 13, 21, 29, 37, 45, 53, 61, 69, 77, 85, 93, 101, 109, 117,
               125);
    v16int a06(6, 14, 22, 30, 38, 46, 54, 62, 70, 78, 86, 94, 102, 110, 118,
               126);
    v16int a07(7, 15, 23, 31, 39, 47, 55, 63, 71, 79, 87, 95, 103, 111, 119,
               127);
    ...
    store_16x8_tr_p(a00, a01, a02, a03, a04, a05, a06, a07, mem, mem + 16,
                    mem + 32, mem + 48, mem + 64, mem + 80, mem + 96,
                    mem + 112);
...
TEST(v16, test_store_16x16_tr_p) {
    ...
    v16int a07(7, 15, 23, 31, 39, 47, 55, 63, 71, 79, 87, 95, 103, 111, 119,
               127);
    v16int a08(128, 136, 144, 152, 160, 168, 176, 184, 192, 200, 208, 216, 224,
               232, 240, 248);
    v16int a09(129, 137, 145, 153, 161, 169, 177, 185, 193, 201, 209, 217, 225,
               233, 241, 249);
    v16int a10(130, 138, 146, 154, 162, 170, 178, 186, 194, 202, 210, 218, 226,
               234, 242, 250);
    v16int a11(131, 139, 147, 155, 163, 171, 179, 187, 195, 203, 211, 219, 227,
               235, 243, 251);
    v16int a12(132, 140, 148, 156, 164, 172, 180, 188, 196, 204, 212, 220, 228,
               236, 244, 252);
    v16int a13(133, 141, 149, 157, 165, 173, 181, 189, 197, 205, 213, 221, 229,
               237, 245, 253);
    v16int a14(134, 142, 150, 158, 166, 174, 182, 190, 198, 206, 214, 222, 230,
               238, 246, 254);
    v16int a15(135, 143, 151, 159, 167, 175, 183, 191, 199, 207, 215, 223, 231,
               239, 247, 255);
    ...
    store_16x16_tr_p(a00, a01, a02, a03, a04, a05, a06, a07, a08, a09, a10, a11,
                     a12, a13, a14, a15, mem, mem + 16, mem + 32, mem + 48,
                     mem + 64, mem + 80, mem + 96, mem + 112, mem + 128,
                     mem + 144, mem + 160, mem + 176, mem + 192, mem + 208,
                     mem + 224, mem + 240);
