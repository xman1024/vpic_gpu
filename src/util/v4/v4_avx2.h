...
inline void load_4x1_tr(const void* a0,
                        ...
                        const void* a3,
                        v4& a) {
    a.v = _mm_setr_ps(((const float*)a0)[0], ((const float*)a1)[0],
...
inline v4float rsqrt(const v4float& a) {
    ...
    b.v = _mm_fmadd_ps(
        _mm_set1_ps(0.5f),
        _mm_fnmadd_ps(a.v, _mm_mul_ps(b_v, _mm_mul_ps(b_v, b_v)), b_v), b_v);
...
inline v4float rcp(const v4float& a) {
    ...
    b.v = _mm_fnmadd_ps(a.v, _mm_mul_ps(b_v, b_v), _mm_add_ps(b_v, b_v));
