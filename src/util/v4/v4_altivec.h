...
class v4 {
    ...
    friend inline void load_4x1_tr(const void* a0,
                                   const void* a1,
                                   const void* a2,
                                   const void* a3,
                                   v4& a);
    ...
    friend inline void store_4x1_tr(const v4& a,
                                    ...
                                    void* a2,
                                    void* a3);
    friend inline void store_4x2_tr(const v4& a,
                                    const v4& b,
                                    void* ALIGNED(8) a0,
                                    void* ALIGNED(8) a1,
                                    void* ALIGNED(8) a2,
                                    void* ALIGNED(8) a3);
    friend inline void store_4x3_tr(const v4& a,
                                    const v4& b,
                                    const v4& c,
                                    void* ALIGNED(16) a0,
                                    void* ALIGNED(16) a1,
                                    void* ALIGNED(16) a2,
                                    void* ALIGNED(16) a3);
    friend inline void store_4x4_tr(const v4& a,
                                    const v4& b,
                                    const v4& c,
                                    const v4& d,
                                    void* ALIGNED(16) a0,
...
#define ASSIGN(op, instr)                       \
    ...
    ASSIGN(
        *=,
        ...
        t.v = v;
        u.v = b.v;
        v   = (_v4_float)((_v4_int){t.i[0] * u.i[0], t.i[1] * u.i[1],
                                  t.i[2] * u.i[2],
...
LOGICAL(!=,
        c.v = (_v4_float)vec_xor(_true, vec_cmpeq((_v4_int)a.v, (_v4_int)b.v)))
LOGICAL(<=,
        c.v = (_v4_float)vec_xor(_true, vec_cmpgt((_v4_int)a.v, (_v4_int)b.v)))
LOGICAL(>=,
        c.v = (_v4_float)vec_xor(_true, vec_cmplt((_v4_int)a.v, (_v4_int)b.v)))
LOGICAL(&&,
        c.v = (_v4_float)vec_xor(_true,
                                 vec_or(vec_cmpeq((_v4_int)a.v, _false),
                                        vec_cmpeq((_v4_int)b.v, _false))))
LOGICAL(||,
        c.v = (_v4_float)vec_xor(_true,
                                 vec_and(vec_cmpeq((_v4_int)a.v, _false),
                                         vec_cmpeq((_v4_int)b.v, _false))))
...
LOGICAL(&&,
        c.v = (_v4_float)vec_xor(vec_or(vec_cmpeq(a.v, _zero),
                                        vec_cmpeq(b.v, _zero)),
                                 _true))
LOGICAL(||,
        c.v = (_v4_float)vec_xor(vec_and(vec_cmpeq(a.v, _zero),
                                         vec_cmpeq(b.v, _zero)),
                                 _true))
...
#define CMATH_FR1(fn)                                                \
    inline v4float fn(const v4float& a) {                            \
        ...
        v4float b;                                                   \
        t.v = a.v;                                                   \
        b.v = (_v4_float){(float)::fn(t.f[0]), (float)::fn(t.f[1]),  \
                          (float)::fn(t.f[2]), (float)::fn(t.f[3])}; \
        return b;                                                    \
    }
...
#define CMATH_FR2(fn)                                                  \
    inline v4float fn(const v4float& a, const v4float& b) {            \
        ...
        u.v = b.v;                                                     \
        c.v = (_v4_float){                                             \
            (float)::fn(t.f[0], u.f[0]), (float)::fn(t.f[1], u.f[1]),  \
            (float)::fn(t.f[2], u.f[2]), (float)::fn(t.f[3], u.f[3])}; \
        return c;                                                      \
    }
...
inline void trilinear(v4float& wl, v4float& wh) {
    ...
    xy   = vec_madd(vec_perm(xy, xy, _PERM(0, 1, 0, 1)), vec_mergel(xy, xy),
                  _zero);
