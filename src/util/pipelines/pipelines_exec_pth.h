...
#define EXEC_PIPELINES(name, args, str)                                        \
    thread.dispatch((pipeline_func_t)name##_pipeline_v16, args, sizeof(*args), \
                    str);                                                      \
...
#define EXEC_PIPELINES(name, args, str)                                       \
    thread.dispatch((pipeline_func_t)name##_pipeline_v8, args, sizeof(*args), \
                    str);                                                     \
    name##_pipeline_scalar(args + str * N_PIPELINE, N_PIPELINE, N_PIPELINE)
...
#define EXEC_PIPELINES(name, args, str)                                       \
    thread.dispatch((pipeline_func_t)name##_pipeline_v4, args, sizeof(*args), \
                    str);                                                     \
    name##_pipeline_scalar(args + str * N_PIPELINE, N_PIPELINE, N_PIPELINE)
