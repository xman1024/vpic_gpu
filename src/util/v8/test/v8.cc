...
TEST(v8, test_load_8x1) {
    ...
    ASSERT_FALSE(any(a0 != v8int(0, 1, 2, 3, 4, 5, 6, 7)) ||
                 ...
                 any(a3 != v8int(24, 25, 26, 27, 28, 29, 30, 31)) || i != 32);
}
...
TEST(v8, test_load_8x1_tr) {
    ...
    load_8x1_tr(mem, mem + 8, mem + 16, mem + 24, mem + 32, mem + 40, mem + 48,
                mem + 56, a0);
    load_8x1_tr(mem + 1, mem + 9, mem + 17, mem + 25, mem + 33, mem + 41,
                mem + 49, mem + 57, a1);
    load_8x1_tr(mem + 2, mem + 10, mem + 18, mem + 26, mem + 34, mem + 42,
                mem + 50, mem + 58, a2);
    load_8x1_tr(mem + 3, mem + 11, mem + 19, mem + 27, mem + 35, mem + 43,
                mem + 51, mem + 59, a3);
    load_8x1_tr(mem + 4, mem + 12, mem + 20, mem + 28, mem + 36, mem + 44,
                mem + 52, mem + 60, a4);
    load_8x1_tr(mem + 5, mem + 13, mem + 21, mem + 29, mem + 37, mem + 45,
                mem + 53, mem + 61, a5);
    load_8x1_tr(mem + 6, mem + 14, mem + 22, mem + 30, mem + 38, mem + 46,
                mem + 54, mem + 62, a6);
    load_8x1_tr(mem + 7, mem + 15, mem + 23, mem + 31, mem + 39, mem + 47,
                mem + 55, mem + 63, a7);
    ...
    ASSERT_FALSE(any(a0 != v8int(0, 8, 16, 24, 32, 40, 48, 56)) ||
                 ...
                 any(a5 != v8int(5, 13, 21, 29, 37, 45, 53, 61)) ||
                 any(a6 != v8int(6, 14, 22, 30, 38, 46, 54, 62)) ||
                 any(a7 != v8int(7, 15, 23, 31, 39, 47, 55, 63)) || i != 64);
}
...
TEST(v8, test_load_8x2_tr) {
    ...
    load_8x2_tr(mem, mem + 8, mem + 16, mem + 24, mem + 32, mem + 40, mem + 48,
                mem + 56, a0, a1);
    load_8x2_tr(mem + 2, mem + 10, mem + 18, mem + 26, mem + 34, mem + 42,
                mem + 50, mem + 58, a2, a3);
    load_8x2_tr(mem + 4, mem + 12, mem + 20, mem + 28, mem + 36, mem + 44,
                mem + 52, mem + 60, a4, a5);
    load_8x2_tr(mem + 6, mem + 14, mem + 22, mem + 30, mem + 38, mem + 46,
                mem + 54, mem + 62, a6, a7);
...
TEST(v8, test_load_8x2_tr_a) {
    ...
    load_8x2_tr(mem, mem + 2, mem + 4, mem + 6, mem + 8, mem + 10, mem + 12,
                mem + 14, a0, a1);
    load_8x2_tr(mem + 16, mem + 18, mem + 20, mem + 22, mem + 24, mem + 26,
                mem + 28, mem + 30, a2, a3);
    load_8x2_tr(mem + 32, mem + 34, mem + 36, mem + 38, mem + 40, mem + 42,
                mem + 44, mem + 46, a4, a5);
    load_8x2_tr(mem + 48, mem + 50, mem + 52, mem + 54, mem + 56, mem + 58,
                mem + 60, mem + 62, a6, a7);
    ...
    ASSERT_FALSE(any(a0 != v8int(0, 2, 4, 6, 8, 10, 12, 14)) ||
                 ...
                 any(a7 != v8int(49, 51, 53, 55, 57, 59, 61, 63)) || i != 64);
}
...
TEST(v8, test_load_8x3_tr) {
    ...
    load_8x3_tr(mem, mem + 8, mem + 16, mem + 24, mem + 32, mem + 40, mem + 48,
                mem + 56, a0, a1, a2);
    ...
    ASSERT_FALSE(any(a0 != v8int(0, 8, 16, 24, 32, 40, 48, 56)) ||
                 any(a1 != v8int(1, 9, 17, 25, 33, 41, 49, 57)) ||
                 any(a2 != v8int(2, 10, 18, 26, 34, 42, 50, 58)) || i != 64);
}
...
TEST(v8, test_load_8x4_tr) {
    ...
    load_8x4_tr(mem, mem + 8, mem + 16, mem + 24, mem + 32, mem + 40, mem + 48,
                mem + 56, a0, a1, a2, a3);
    ...
    ASSERT_FALSE(any(a0 != v8int(0, 8, 16, 24, 32, 40, 48, 56)) ||
                 any(a1 != v8int(1, 9, 17, 25, 33, 41, 49, 57)) ||
                 any(a2 != v8int(2, 10, 18, 26, 34, 42, 50, 58)) ||
                 any(a3 != v8int(3, 11, 19, 27, 35, 43, 51, 59)) || i != 64);
}
...
TEST(v8, test_load_8x4_tr_a) {
    ...
    load_8x4_tr(mem, mem + 4, mem + 8, mem + 12, mem + 16, mem + 20, mem + 24,
                mem + 28, a0, a1, a2, a3);
    ...
    ASSERT_FALSE(any(a0 != v8int(0, 4, 8, 12, 16, 20, 24, 28)) ||
                 ...
                 any(a3 != v8int(3, 7, 11, 15, 19, 23, 27, 31)) || i != 64);
}
...
TEST(v8, test_load_8x8_tr) {
    ...
    load_8x8_tr(mem, mem + 8, mem + 16, mem + 24, mem + 32, mem + 40, mem + 48,
                mem + 56, a0, a1, a2, a3, a4, a5, a6, a7);
...
TEST(v8, test_store_8x1_tr) {
    ...
    store_8x1_tr(a0, mem, mem + 8, mem + 16, mem + 24, mem + 32, mem + 40,
                 mem + 48, mem + 56);
    store_8x1_tr(a1, mem + 1, mem + 9, mem + 17, mem + 25, mem + 33, mem + 41,
                 mem + 49, mem + 57);
    store_8x1_tr(a2, mem + 2, mem + 10, mem + 18, mem + 26, mem + 34, mem + 42,
                 mem + 50, mem + 58);
    store_8x1_tr(a3, mem + 3, mem + 11, mem + 19, mem + 27, mem + 35, mem + 43,
                 mem + 51, mem + 59);
    store_8x1_tr(a4, mem + 4, mem + 12, mem + 20, mem + 28, mem + 36, mem + 44,
                 mem + 52, mem + 60);
    store_8x1_tr(a5, mem + 5, mem + 13, mem + 21, mem + 29, mem + 37, mem + 45,
                 mem + 53, mem + 61);
    store_8x1_tr(a6, mem + 6, mem + 14, mem + 22, mem + 30, mem + 38, mem + 46,
                 mem + 54, mem + 62);
    store_8x1_tr(a7, mem + 7, mem + 15, mem + 23, mem + 31, mem + 39, mem + 47,
                 mem + 55, mem + 63);
...
TEST(v8, test_store_8x2_tr) {
    ...
    store_8x2_tr(a0, a1, mem, mem + 8, mem + 16, mem + 24, mem + 32, mem + 40,
                 mem + 48, mem + 56);
    store_8x2_tr(a2, a3, mem + 2, mem + 10, mem + 18, mem + 26, mem + 34,
                 mem + 42, mem + 50, mem + 58);
    store_8x2_tr(a4, a5, mem + 4, mem + 12, mem + 20, mem + 28, mem + 36,
                 mem + 44, mem + 52, mem + 60);
    store_8x2_tr(a6, a7, mem + 6, mem + 14, mem + 22, mem + 30, mem + 38,
                 mem + 46, mem + 54, mem + 62);
...
TEST(v8, test_store_8x2_tr_a) {
    ...
    store_8x2_tr(a0, a1, mem, mem + 2, mem + 4, mem + 6, mem + 8, mem + 10,
                 mem + 12, mem + 14);
    store_8x2_tr(a2, a3, mem + 16, mem + 18, mem + 20, mem + 22, mem + 24,
                 mem + 26, mem + 28, mem + 30);
    store_8x2_tr(a4, a5, mem + 32, mem + 34, mem + 36, mem + 38, mem + 40,
                 mem + 42, mem + 44, mem + 46);
    store_8x2_tr(a6, a7, mem + 48, mem + 50, mem + 52, mem + 54, mem + 56,
                 mem + 58, mem + 60, mem + 62);
...
TEST(v8, test_store_8x3_tr) {
    ...
    store_8x3_tr(a0, a1, a2, mem, mem + 8, mem + 16, mem + 24, mem + 32,
                 mem + 40, mem + 48, mem + 56);

    j = 0;
    for (i = 0; i < 8; i++) {
        if ((i < 3 && mem[i] != i) || (i >= 3 && mem[i] != 0))
            break;
        else
            j++;

        if ((i < 3 && mem[i + 8] != i + 8) || (i >= 3 && mem[i + 8] != 0))
            break;
        else
            j++;

        if ((i < 3 && mem[i + 16] != i + 16) || (i >= 3 && mem[i + 16] != 0))
            break;
        else
            j++;

        if ((i < 3 && mem[i + 24] != i + 24) || (i >= 3 && mem[i + 24] != 0))
            break;
        else
            j++;

        if ((i < 3 && mem[i + 32] != i + 32) || (i >= 3 && mem[i + 32] != 0))
            break;
        else
            j++;

        if ((i < 3 && mem[i + 40] != i + 40) || (i >= 3 && mem[i + 40] != 0))
            break;
        else
            j++;

        if ((i < 3 && mem[i + 48] != i + 48) || (i >= 3 && mem[i + 48] != 0))
            break;
        else
            j++;

        if ((i < 3 && mem[i + 56] != i + 56) || (i >= 3 && mem[i + 56] != 0))
            break;
        else
            j++;
    }
    ...
    ASSERT_FALSE(any(a0 != v8int(0, 8, 16, 24, 32, 40, 48, 56)) ||
                 ...
                 any(a5 != v8int(5, 13, 21, 29, 37, 45, 53, 61)) ||
                 any(a6 != v8int(6, 14, 22, 30, 38, 46, 54, 62)) ||
                 any(a7 != v8int(7, 15, 23, 31, 39, 47, 55, 63)) || j != 64);
}
...
TEST(v8, test_store_8x4_tr) {
    ...
    store_8x4_tr(a0, a1, a2, a3, mem, mem + 8, mem + 16, mem + 24, mem + 32,
                 mem + 40, mem + 48, mem + 56);

    store_8x4_tr(a4, a5, a6, a7, mem + 4, mem + 12, mem + 20, mem + 28,
                 mem + 36, mem + 44, mem + 52, mem + 60);
...
TEST(v8, test_store_8x4_tr_a) {
    ...
    store_8x4_tr(a0, a1, a2, a3, mem, mem + 4, mem + 8, mem + 12, mem + 16,
                 mem + 20, mem + 24, mem + 28);

    store_8x4_tr(a4, a5, a6, a7, mem + 32, mem + 36, mem + 40, mem + 44,
                 mem + 48, mem + 52, mem + 56, mem + 60);
    ...
    ASSERT_FALSE(any(a0 != v8int(0, 4, 8, 12, 16, 20, 24, 28)) ||
                 ...
                 any(a7 != v8int(35, 39, 43, 47, 51, 55, 59, 63)) || i != 64);
}
...
TEST(v8, test_store_8x8_tr) {
    ...
    store_8x8_tr(a0, a1, a2, a3, a4, a5, a6, a7, mem, mem + 8, mem + 16,
                 mem + 24, mem + 32, mem + 40, mem + 48, mem + 56);
