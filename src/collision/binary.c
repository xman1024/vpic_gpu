...
void apply_binary_collision_model(binary_collision_model_t* cm) {
...
void checkpt_binary_collision_model(const collision_op_t* cop) {
...
collision_op_t* restore_binary_collision_model(void) {
...
void delete_binary_collision_model(collision_op_t* cop) {
...
collision_op_t* binary_collision_model(
    ...
    return new_collision_op_internal(
        cm, (collision_op_func_t)apply_binary_collision_model,
        delete_binary_collision_model,
        (checkpt_func_t)checkpt_binary_collision_model,
        (restore_func_t)restore_binary_collision_model, NULL);
}
