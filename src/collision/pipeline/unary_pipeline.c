...
void apply_unary_collision_model_pipeline(unary_collision_model_t* cm) {
    int p, n_large_pr = 0;
    ...
    if (n_large_pr) {
        WARNING(
            ("%i particles in species \"%s\" encountered a large collision "
