...
void center_p_pipeline_v4(center_p_pipeline_args_t* args,
                          int pipeline_rank,
                          int n_pipeline);

void center_p_pipeline_v8(center_p_pipeline_args_t* args,
                          int pipeline_rank,
                          int n_pipeline);
void center_p_pipeline_v16(center_p_pipeline_args_t* args,
                           int pipeline_rank,
                           int n_pipeline);
...
void uncenter_p_pipeline_v4(center_p_pipeline_args_t* args,
                            int pipeline_rank,
                            int n_pipeline);

void uncenter_p_pipeline_v8(center_p_pipeline_args_t* args,
                            int pipeline_rank,
                            int n_pipeline);

void uncenter_p_pipeline_v16(center_p_pipeline_args_t* args,
                             int pipeline_rank,
                             int n_pipeline);
...
void energy_p_pipeline_v4(energy_p_pipeline_args_t* args,
                          int pipeline_rank,
                          int n_pipeline);

void energy_p_pipeline_v8(energy_p_pipeline_args_t* args,
                          int pipeline_rank,
                          int n_pipeline);
...
#define V2P(v, P, vl, vh) \
    ((((int64_t)((v) - (vl))) * ((int64_t)(P))) / ((int64_t)((vh) - (vl) + 1)))
...
#define P2V(p, P, vl, vh)                                                    \
    ((vl) +                                                                  \
     ((((int64_t)(p)) * ((int64_t)((vh) - (vl) + 1)) + ((int64_t)((P)-1))) / \
      ((int64_t)(P))))
