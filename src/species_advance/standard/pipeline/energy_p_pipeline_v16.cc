...
void energy_p_pipeline_v16(energy_p_pipeline_args_t* args,
                           int pipeline_rank,
                           int n_pipeline) {
    ...
    for (; nq; nq--, p += 16) {
        ...
        //--------------------------------------------------------------------------
        load_16x4_tr(&p[0].dx, &p[1].dx, &p[2].dx, &p[3].dx, &p[4].dx, &p[5].dx,
                     &p[6].dx, &p[7].dx, &p[8].dx, &p[9].dx, &p[10].dx,
                     &p[11].dx, &p[12].dx, &p[13].dx, &p[14].dx, &p[15].dx, dx,
                     dy, dz, i);
        ...
        //--------------------------------------------------------------------------
        load_16x4_tr(vp00, vp01, vp02, vp03, vp04, vp05, vp06, vp07, vp08, vp09,
                     vp10, vp11, vp12, vp13, vp14, vp15, ex, v00, v01, v02);
        ...
        // Load interpolation data for particles.
        //--------------------------------------------------------------------------
        load_16x4_tr(vp00 + 4, vp01 + 4, vp02 + 4, vp03 + 4, vp04 + 4, vp05 + 4,
                     vp06 + 4, vp07 + 4, vp08 + 4, vp09 + 4, vp10 + 4, vp11 + 4,
                     vp12 + 4, vp13 + 4, vp14 + 4, vp15 + 4, ey, v00, v01, v02);
        ...
        // Load interpolation data for particles.
        //--------------------------------------------------------------------------
        load_16x4_tr(vp00 + 8, vp01 + 8, vp02 + 8, vp03 + 8, vp04 + 8, vp05 + 8,
                     vp06 + 8, vp07 + 8, vp08 + 8, vp09 + 8, vp10 + 8, vp11 + 8,
                     vp12 + 8, vp13 + 8, vp14 + 8, vp15 + 8, ez, v00, v01, v02);
        ...
        //--------------------------------------------------------------------------
        load_16x4_tr(&p[0].ux, &p[1].ux, &p[2].ux, &p[3].ux, &p[4].ux, &p[5].ux,
                     &p[6].ux, &p[7].ux, &p[8].ux, &p[9].ux, &p[10].ux,
                     &p[11].ux, &p[12].ux, &p[13].ux, &p[14].ux, &p[15].ux, v00,
                     v01, v02, w);

        //--------------------------------------------------------------------------
        // Update momentum to half step. Note that Boris rotation does not
        // change energy and thus is not necessary.
        //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    args->en[pipeline_rank] = en00 + en01 + en02 + en03 + en04 + en05 + en06 +
                              en07 + en08 + en09 + en10 + en11 + en12 + en13 +
                              en14 + en15;
}
