...
void uncenter_p_pipeline_v8(center_p_pipeline_args_t* args,
    ...
    const v8float qdt_4mc(-0.5 *
                          args->qdt_2mc);  // For backward half Boris rotate.
    ...
    for (; nq; nq--, p += 8) {
        ...
        // Load particle data.
        //--------------------------------------------------------------------------
        load_8x4_tr(&p[0].dx, &p[1].dx, &p[2].dx, &p[3].dx, &p[4].dx, &p[5].dx,
                    &p[6].dx, &p[7].dx, dx, dy, dz, ii);
        ...
        //--------------------------------------------------------------------------
        load_8x4_tr(vp00, vp01, vp02, vp03, vp04, vp05, vp06, vp07, hax, v00,
                    v01, v02);
        ...
        // Load interpolation data for particles.
        //--------------------------------------------------------------------------
        load_8x4_tr(vp00 + 4, vp01 + 4, vp02 + 4, vp03 + 4, vp04 + 4, vp05 + 4,
                    vp06 + 4, vp07 + 4, hay, v03, v04, v05);
        ...
        // Load interpolation data for particles.
        //--------------------------------------------------------------------------
        load_8x4_tr(vp00 + 8, vp01 + 8, vp02 + 8, vp03 + 8, vp04 + 8, vp05 + 8,
                    vp06 + 8, vp07 + 8, haz, v00, v01, v02);
        ...
        // Load interpolation data for particles.
        //--------------------------------------------------------------------------
        load_8x4_tr(vp00 + 12, vp01 + 12, vp02 + 12, vp03 + 12, vp04 + 12,
                    vp05 + 12, vp06 + 12, vp07 + 12, cbx, v03, cby, v04);
        ...
        //--------------------------------------------------------------------------
        load_8x4_tr(&p[0].ux, &p[1].ux, &p[2].ux, &p[3].ux, &p[4].ux, &p[5].ux,
                    &p[6].ux, &p[7].ux, ux, uy, uz, q);
