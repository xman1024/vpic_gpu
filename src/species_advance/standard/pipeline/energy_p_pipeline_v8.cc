...
void energy_p_pipeline_v8(energy_p_pipeline_args_t* args,
    ...
    for (; nq; nq--, p += 8) {
        ...
        //--------------------------------------------------------------------------
        load_8x4_tr(vp00, vp01, vp02, vp03, vp04, vp05, vp06, vp07, ex, v00,
                    v01, v02);
    ...
    args->en[pipeline_rank] =
        en00 + en01 + en02 + en03 + en04 + en05 + en06 + en07;
}
