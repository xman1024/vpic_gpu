...
void advance_p_pipeline_v8(advance_p_pipeline_args_t* args,
                           int pipeline_rank,
                           int n_pipeline) {
    ...
    for (; nq; nq--, p += 8) {
        ...
        // Load particle data.
        //--------------------------------------------------------------------------
        load_8x8_tr(&p[0].dx, &p[1].dx, &p[2].dx, &p[3].dx, &p[4].dx, &p[5].dx,
                    &p[6].dx, &p[7].dx, dx, dy, dz, ii, ux, uy, uz, q);
        ...
        //--------------------------------------------------------------------------
        load_8x8_tr(vp00, vp01, vp02, vp03, vp04, vp05, vp06, vp07, hax, v00,
                    v01, v02, hay, v03, v04, v05);
        ...
        // Load interpolation data for particles.
        //--------------------------------------------------------------------------
        load_8x8_tr(vp00 + 8, vp01 + 8, vp02 + 8, vp03 + 8, vp04 + 8, vp05 + 8,
                    vp06 + 8, vp07 + 8, haz, v00, v01, v02, cbx, v03, cby, v04);
        ...
        //--------------------------------------------------------------------------
        load_8x2_tr(vp00 + 16, vp01 + 16, vp02 + 16, vp03 + 16, vp04 + 16,
                    vp05 + 16, vp06 + 16, vp07 + 16, cbz, v05);
        ...
        //--------------------------------------------------------------------------
        store_8x8_tr(v03, v04, v05, ii, v06, v07, v08, q, &p[0].dx, &p[1].dx,
                     &p[2].dx, &p[3].dx, &p[4].dx, &p[5].dx, &p[6].dx,
                     &p[7].dx);
