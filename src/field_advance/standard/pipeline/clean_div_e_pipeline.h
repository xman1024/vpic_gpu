...
#error \
    "Only include clean_div_e_pipeline.h in clean_div_e_pipeline source files."
#endif
...
#define DECLARE_STENCIL()                                       \
    ...
    const float alphadt =                                       \
        0.3888889 / (_rdx * _rdx + _rdy * _rdy + _rdz * _rdz);  \
...
static void clean_div_e_pipeline_scalar(pipeline_args_t* args,
                                        int pipeline_rank,
                                        int n_pipeline);
