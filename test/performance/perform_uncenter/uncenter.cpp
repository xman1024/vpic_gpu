...
#define NUM_PARTICLES 1048576  // 32768
#endif
        int npart =
            NUM_PARTICLES;  // This is independent of the number of cells
        int nstep = 100;
        ...
        std::cout << "Elapsed time: " << elapsed_seconds.count() << ""
                  << std::endl;
        std::cout << "Particles: " << sp->np << ", Steps: " << nstep
                  << std::endl;
        std::cout << "Time per particle step: " << time_per_p
                  << ", Particle/s: " << 1.0 / time_per_p << std::endl;
    }
};

TEST_CASE("repeatedly center and uncenter particles in a timed loop",
          "[uncenter]") {
#ifndef NUM_THREADS
